...
%
study basics of Rigidity theory with the focus on flexible realizations
and their combinatorial characterization using NAC-colorings.
%
In \Cref{chapter:np},
...
and an algorithm for stable cut search on flexible~\cite{stable_cuts_legersky} graphs is described and implemented.
%
