...
Among the goals of this thesis is to provide an algorithm
...
%
The relation of NAC-colorings with stable cuts~\cite{stable_cuts_2v_4} is presented,
and an algorithm for stable cut search is described and implemented.
%
The code implemented in this thesis available at~\cite{my_code}
enriches PyRigi~\cite{pyrigi}
