...
\dirtree{%
	...
	.3 datasets.py                           \DTcomment{loads datasets from \texttt{graphs\_store}}.
	...
	.5 minimally\_rigid\_\{n\}.g6           \DTcomment{all m.\ r.\ graphs on \( n \) vertices}.
	...
	.2 nac                                  \DTcomment{Algorithms in \Cref{chapter:algo}}.
	...
	.3 strategies\_merging.py               \DTcomment{merging heuristics from \Cref{sec:combining}}.
	.3 strategies\_splitting.py             \DTcomment{splitting heuristics from \Cref{sec:combining}}.
	...
	.3 util.py                              \DTcomment{checks for stable cuts}.
	...
	.2 shell.nix                            \DTcomment{setup script for NixOS}.
}
