...
\begin{figure}
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{\centering Connecting element gadget as proposed in~\cite{np_complete}.
...
The edge labeled \WLOG{} by \( x_i \) is identified with the left most
...
\WLOG{} let the connecting edge corresponding to \( \true \) is colored \( \blue \).
...
\begin{proof}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}[scale=1.5]
			...
			\end{scope}
		\end{tikzpicture}
		\caption{\centering A train (left) is formed by gluing braced ladders so that
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}[scale=1.75]
			...
			\end{scope}
		\end{tikzpicture}
		\caption{\centering The gadgets for every variable $x_i$.
	...
	\begin{figure}[h]
		...
		\end{tikzpicture}
		\caption{\centering The gadget for the clause
