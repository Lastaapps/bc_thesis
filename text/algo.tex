...
\todo[inline]{Pohrát si s prázdnou stránkou}
...
\todo[inline]{Consider pseudocode for \CyclesMatchChunks{}}
...
In such cases, we can list all coloring of subgraphs first
...
We use these strategies to divide the graph divided in half by giving it appropriate
...
An important algorithm goes from \Cref{cor:vertex_no_triangle_stable_cut}.
