...
\todo{Uncomment footnote} GitHub.
%GitHub\footnote{\url{https://github.com/Lastaapps/nac_coloring}}.
...
%
\todo{Refactor after runs are run}
%
\begin{figure}[thbp]
	\centering
...
\todo[inline]{Refactor one benchmarks finish}
...
\todo[inline]{Describe split on no NAC \Cref{fig:graph_no_nac_coloring_generated_rigid_failing_split_first_runtime}}

\begin{figure}[thbp]
	\centering
	\scalebox{\BenchFigureScale}{\input{./figures/graph_export_minimally_rigid_random_failing_merging_first_vertex_checks_split_merging_mean.pgf}}
...
\begin{figure}[thbp]
	\centering
	\scalebox{\BenchFigureScale}{\input{./figures/graph_export_minimally_rigid_random_failing_split_first_vertex_checks_split_merging_mean.pgf}}
	\caption[Mean runtime for minimally rigid graphs (some) (with failing).]{
