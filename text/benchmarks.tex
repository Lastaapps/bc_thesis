...
\todo[inline]{Explain how graphs are formed --- grouping and aggregation. Point to all graphs in figures}
\todo[inline]{Ensure \MinMax{} is shown in benchmarks}
\todo[inline]{Document notebook utils}
