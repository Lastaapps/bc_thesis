...
\todo[inline]{Uncomment foot note}
...
\todo[inline]{Vyjádřit se k velikosti podgrafů opraveně}
...
\begin{figure}[p]
	\centering
	\scalebox{0.5}{\input{./figures/graph_export_no_nac_coloring_generated_failing_merging_first_triangle_runtime_split_merging_mean.pgf}}
