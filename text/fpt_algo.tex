...
\begin{proof}
	...
	%
	\todo[inline]{Zvážit, jestli nemám ukazovat, že barvení \( s \) jsou konzistentní s \( s' \) a ne naopak.}
\end{proof}
%
...
\todo[inline]{Zavedeno až v 5.\ kapitole!}
...
\begin{proof}
	...
	these are merged along a path according to \Cref{lemma:fpt_merging_map}.
	%
