...
\begin{figure}[ht]
	...
	\end{center}
	\caption[Nice tree decomposition]{An example of a nice tree decomposition~\cite{nice_tree_decomposition_img}.
...
\begin{definition}[State space]
	...
	%
	All the possible states on \Xt{} form the \emph{state space} \( S_t \).
\end{definition}
%
